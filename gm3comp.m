%gm3comp generates vector spherical harmonic fields in polar components for surface plots, etc
%this version modified 050213 4:57pm by Axl to use different recursion formula to simplify indexing
%
...
%schmidt normalization added by "hand" to fix this
%updated from gm3cart on 050713

function [Sr Stheta Sphi] = gm3comp(n,r,theta,phi);
if ~(nargin==4)
    error('Usage: [Sr Stheta Sphi] = gm3comp(n,r,theta,phi)')
end
