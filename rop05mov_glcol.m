...
%here's a new top view glatzmaier colors same as spag16
set(0,'defaultfigurevisible','off');
load /data/3m/111512/imgp_0p05_lambda/moviegdata.mat
%[bl al] = butter(2,1/128,'low');
DSFAC = 1;
NSPHERE = 8;
%gf = filtfilt(bl,al,gm);
gd = downsample(gdd,DSFAC);
td = downsample(tdd,DSFAC);
DIRNAME = '/data/3m/111512/imgp_0p05_lambda/spag1';
AXLIMTOP=5;
AXLIMSIDE = 3;
...
if exist(DIRNAME)
	cd(DIRNAME)
	system(['cp /home/axl/matlabgit/mag/rop05mov_glcol.m ' DIRNAME '/thisinstance_moviecode.m'])
